                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="thank-you-pop">
                            ...
                            <h1>Thank You!</h1>
                            <p>Your submission is received a</p>
...
<script type="text/javascript">
	$(document).ready(function(){
		            ...
		            for(i=0; i<data.length; i++){
		                html += '<tr>'+
		                        ...
		                        '<td style="text-align:right;">'+
                                    '<a href=" "; class="btn btn-info btn-sm item_edit" data-product_code="'+data[i].product_code+'" data-product_name="'+data[i].product_name+'" data-price="'+data[i].product_price+'">Edit</a>'+' '+
        ...
        $('#btn_save').on('click',function(){
            ...
            $.ajax({
                type : "POST",
                url  : "<?php echo base_url('index.php/product/save')?>",
                dataType : "JSON",
            ...
            $.ajax({
                ...
                success: function(data){
                    ...
                    if(data.status==1 ){
                        swal({
                      title: "Good job!",
                      text: "Successfully deleted the form!",
                      icon: "success",
                      button: "OK!",
                    });
